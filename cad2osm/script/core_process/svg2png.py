...
if __name__ == "__main__":
    # --- 用户可修改路径 ---
    input_dir = "/home/jay/AGSeg_ws/AGSeg/cad2osm/data/web-cad/img/svg_manual_filter" # 输入 SVG 文件夹
    output_dir = "/home/jay/AGSeg_ws/AGSeg/cad2osm/data/web-cad/img/png_manual_filter" # 输出 PNG 文件夹
