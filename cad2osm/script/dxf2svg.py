...
if __name__ == "__main__":
    # --- 用户可修改路径 ---
    input_dir = "/home/jay/AGSeg_ws/AGSeg/cad2osm/data/data_dxf/us-standard-download/" # 输入 DXF 文件夹
    output_dir = "/home/jay/AGSeg_ws/AGSeg/cad2osm/data/data_img/svg-web-original/" # 输出 SVG 文件夹
    # --------------------
